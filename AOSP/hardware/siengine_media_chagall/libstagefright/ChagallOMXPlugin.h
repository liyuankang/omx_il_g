...
#ifndef CHAGALL_OMX_PLUGIN_H_
#define CHAGALL_OMX_PLUGIN_H_

#include <OMXPluginBase.h>

namespace android {

struct ChagallOMXPlugin : public OMXPluginBase {
    ChagallOMXPlugin();
    virtual ~ChagallOMXPlugin();
...
private:
    ...
    ChagallOMXPlugin(const ChagallOMXPlugin &);
    ChagallOMXPlugin &operator=(const ChagallOMXPlugin &);
};

}  // namespace android

#endif  // CHAGALL_OMX_PLUGIN_H_
