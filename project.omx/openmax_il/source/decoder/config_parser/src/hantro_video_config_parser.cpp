...
#include "hantro_video_config_parser.h"
#include "hantro_m4v_config_parser.h"
#include "oscl_mem.h"
...
OSCL_EXPORT_REF int16 hantro_video_config_parser(hantroVideoConfigParserInputs *aInputs, hantroVideoConfigParserOutputs *aOutputs)
{
