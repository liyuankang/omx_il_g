...
refencode() {
    ...
    --adaptiveRoi=${adaptiveRoi[${set_nro}]} \
    --adaptiveRoiColor=${adaptiveRoiColor[${set_nro}]} \
    --layerBitPerSecond0=${baseLayerBitrate[${set_nro}]} \
    --layerBitPerSecond1=${layer1Bitrate[${set_nro}]} \
    --layerBitPerSecond2=${layer2Bitrate[${set_nro}]} \
    --layerBitPerSecond3=${layer3Bitrate[${set_nro}]}
...
#        omxLastVop="$[${lastVop[${set_nro}]}+1]"
    ...
    -TL0 ${baseLayerBitrate[${set_nro}]} \
    -TL1 ${layer1Bitrate[${set_nro}]} \
    -TL2 ${layer2Bitrate[${set_nro}]} \
    -TL3 ${layer3Bitrate[${set_nro}]}
}
