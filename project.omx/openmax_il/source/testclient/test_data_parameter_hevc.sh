...
#--
#--  $RCSfile: test_data_parameter_hevc.sh,v $
...
case "$1" in
	...
	testId=(		0	0	1	0	0	)
        category=("hevc_intra"
                  ...
                  "hevc_intra"
                  "hevc_hrd")
	desc=(	"HEVC Intra release test. Size 352x288, begins with QP 51. VopRc, 384 Kbps."
		"HEVC Intra release test. Size 288x224, begins with QP 51. VopRc, 768 Kbps."
		""
		""
		""
		"Unsupported for OMX rate control types(HEVC HRD testing. Causing frame skips. SEI enabled.)"	)
	};;
	...
	testId=(		0	0	0	0	0	)
        category=("hevc_rate_control"
                  ...
                  "hevc_rate_control"
                  "hevc_rate_control")
	desc=(	"Test hevc rate control with HRD"
		"Test hevc rate control with HRD overflow and underflow"
		"Test hevc rate control with HRD overflow and underflow"
		"Test hevc rate control problem situations"
		"Test hevc rate control problem situations"	)
	};;
