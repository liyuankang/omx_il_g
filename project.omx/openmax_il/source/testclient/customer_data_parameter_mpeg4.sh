...
case "$1" in
	...
	hec=(			    0		0	    0		0	    0	)
	gobPlace=(		    0		0	    0		0	    3	)
	bitPerSecond=(      0		100000  192000	0		100000	)
	vopRc=(			    0		1	    1		0	    1	)
	mbRc=(			    0		0	    0		0	    1	)
	...
	horOffsetSrc=(		0       0)
	verOffsetSrc=(		0       0)
	outputRateNumer=(	25	    30000)
	outputRateDenom=(	1	    1001)
	inputRateNumer=(	25	    30000)
	inputRateDenom=(	1	    1001)
	scheme=(		    0		3)
	profile=(		    52	    1007)
	intraVopRate=(		15		15)
	goVopRate=(		    0		0)
	...
	stabilization=(		1	    1)
	userDataVos=(		$ud1	$ud1)
	userDataVisObj=(	$ud2	$ud2)
	userDataVol=(		$ud3	$ud3)
	userDataGov=(		$ud4	$ud4)
	testId=(		    0	    0)
        category=( "stabilization"
                   "stabilization")
	desc=(	"Test stabilization Mpeg4"
            "Test stabilization H263"   )
	};;
