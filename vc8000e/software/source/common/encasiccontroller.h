...
#define ASIC_FRAME_BUF_CUINFO_MAX       (X265_LOOKAHEAD_MAX+X265_BFRAME_MAX+MAX_CORE_NUM-1)
...
typedef struct
{
  ...
  ptr_t Av1PreoutputStrmBase[MAX_STRM_BUF_NUM];
  ...
  u32 sw_cdef_damping;
  u32 sw_cdef_bits;
  u32 sw_cdef_strengths;
  u32 sw_cdef_uv_strengths;
...
typedef struct
{
  ...
  EWLLinearMem_t internalAv1FrameContext[ASIC_FRAME_BUF_LUM_MAX];
