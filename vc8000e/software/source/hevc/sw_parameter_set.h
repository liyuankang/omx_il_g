...
struct sps
{
  ...
  /* AV1 definations*/
  true_e  still_picture;
  true_e  reduced_still_picture_hdr;
  true_e  timing_info_present_flag;
  true_e  decoder_model_info_present_flag;
  true_e  initial_display_delay_present_flag;
  true_e  use_128x128_superblock;
  true_e  enable_filter_intra;
  true_e  enable_intra_edge_filter;
  true_e  frame_id_numbers_present_flag;
  true_e  enable_interintra_compound;
  true_e  enable_masked_compound;
  true_e  enable_warped_motion;
  true_e  enable_dual_filter;
  true_e  enable_order_hint;
  true_e  enable_jnt_comp;
  true_e  enable_ref_frame_mvs;
  true_e  choose_screen_content_tools;
  true_e  force_screen_content_tools;
  true_e  force_integer_mv;
  true_e  enable_superres;
  true_e  enable_cdef;
  true_e  enable_restoration;
  true_e  film_grain_params_present;
  true_e  separate_uv_delta_q;
  u32     operating_points_cnt_minus1;
  u32     order_hint_bits;
  u32     frame_id_length;
...
struct pps
{
  ...
  true_e transform8x8Mode; /*H264 8x8 tranform, 0:1 disable/enable 8x8 transform*/
};
...
void init_poc_list(struct rps *r, i32 poc, bool is_ltr_cur, u32 codingType, struct container *c, bool bH264, const bool *pLTR_used);
