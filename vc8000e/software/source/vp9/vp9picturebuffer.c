...
void PictureBufferSetRef(picBuffer *picBuffer, asicData_s *asic)
{
  ...
  if (picBuffer->cur_pic->p_frame)
  {
    ...
    asic->regs.pRefPic_recon_l0[0][0] = refPicList[refIdx].picture.lum;
    asic->regs.pRefPic_recon_l0[1][0] = refPicList[refIdx].picture.cb;
    asic->regs.pRefPic_recon_l0[0][1] = refPicList[refIdx].picture.lum;
    asic->regs.pRefPic_recon_l0[1][1] = refPicList[refIdx].picture.cb;
    asic->regs.mvRefIdx[0] = asic->regs.mvRefIdx[1] = refIdx;
    ...
    if (refIdx2 != -1)
    {
      asic->regs.pRefPic_recon_l0[0][1] = refPicList[refIdx2].picture.lum;
      asic->regs.pRefPic_recon_l0[1][1] = refPicList[refIdx2].picture.cb;
  ...
  asic->regs.reconLumBase = picBuffer->cur_pic->picture.lum;
  asic->regs.reconCbBase = picBuffer->cur_pic->picture.cb;
#if 0
