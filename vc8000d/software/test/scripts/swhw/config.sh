...
export DEC_SERVICE_MERGE_DISABLE="DISABLED"

export DEC_MULTICORE_DECODE="DISABLED"
...
# Test cases that match the provided tools are not run and/or checked (for internal testing)
if [ "$DEC_MULTICORE_DECODE" == "DISABLED" ]
then
    export TB_H264_TOOLS_NOT_SUPPORTED_RUN="DISABLED"
    export TB_H264_TOOLS_NOT_SUPPORTED_CHECK="DISABLED"
else
    export TB_H264_TOOLS_NOT_SUPPORTED_RUN="DISABLED"
    export TB_H264_TOOLS_NOT_SUPPORTED_CHECK="Error,ASO,FMO"
fi
...
then
    export H264_DECODER="../../../h264high/hx170dec-arm"
    if [ "$PRODUCT" == "g1" ]
    then
        export H264_DECODER_MC="../../../h264high/hx170dec-arm-mc"
    fi
fi
...
then
    ...
    export H264_DECODER_REF_MC="../../${SWTAG}/software/test/h264high/hx170dec_pclinux-mc"
fi

# Input streams
export H264_STREAM="stream.h264"
export H264_STREAM_MC="stream.mp4"
...
export VP8_DECODER_MC=""
if [ "$PRODUCT" == "g1" ]
then
    export VP8_DECODER_MC="../../../vp8/vp8x170dec_versatile-mc"
fi

# For internal testing, only
export VP8_DECODER_REF="../../${SWTAG}/software/test/vp8/vp8x170dec_pclinux"
export VP8_DECODER_REF_MC="../../${SWTAG}/software/test/vp8/vp8x170dec_pclinux-mc"
